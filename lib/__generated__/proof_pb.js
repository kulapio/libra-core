 ...
 * @const
 */
proto.types.AccumulatorConsistencyProof.repeatedFields_ = [1,3];
...
proto.types.AccumulatorConsistencyProof.toObject = function(includeInstance, msg) {
  var f, obj = {
    frozenSubtreeRootsList: msg.getFrozenSubtreeRootsList_asB64(),
    numSiblings: jspb.Message.getFieldWithDefault(msg, 2, 0),
    nonDefaultSiblingsList: msg.getNonDefaultSiblingsList_asB64()
  };
...
proto.types.AccumulatorConsistencyProof.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.addFrozenSubtreeRoots(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setNumSiblings(value);
      break;
    case 3:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.addNonDefaultSiblings(value);
...
proto.types.AccumulatorConsistencyProof.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFrozenSubtreeRootsList_asU8();
  if (f.length > 0) {
    writer.writeRepeatedBytes(
      1,
      f
 ...
 * @return {!(Array<!Uint8Array>|Array<string>)}
 */
proto.types.AccumulatorConsistencyProof.prototype.getFrozenSubtreeRootsList = function() {
...
/**
 * repeated bytes frozen_subtree_roots = 1;
 * This is a type-conversion wrapper around `getFrozenSubtreeRootsList()`
 * @return {!Array<string>}
 */
proto.types.AccumulatorConsistencyProof.prototype.getFrozenSubtreeRootsList_asB64 = function() {
  return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(
      this.getFrozenSubtreeRootsList()));
};
 ...
 * @return {!Array<!Uint8Array>}
 */
proto.types.AccumulatorConsistencyProof.prototype.getFrozenSubtreeRootsList_asU8 = function() {
  return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(
      this.getFrozenSubtreeRootsList()));
};
...
/** @param {!(Array<!Uint8Array>|Array<string>)} value */
proto.types.AccumulatorConsistencyProof.prototype.setFrozenSubtreeRootsList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.types.AccumulatorConsistencyProof.prototype.addFrozenSubtreeRoots = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.types.AccumulatorConsistencyProof.prototype.clearFrozenSubtreeRootsList = function() {
  this.setFrozenSubtreeRootsList([]);
};


/**
 * optional uint32 num_siblings = 2;
 * @return {number}
 */
proto.types.AccumulatorConsistencyProof.prototype.getNumSiblings = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.types.AccumulatorConsistencyProof.prototype.setNumSiblings = function(value) {
 ...
 * @return {!(Array<!Uint8Array>|Array<string>)}
 */
proto.types.AccumulatorConsistencyProof.prototype.getNonDefaultSiblingsList = function() {
  return /** @type {!(Array<!Uint8Array>|Array<string>)} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!Array<string>}
 */
proto.types.AccumulatorConsistencyProof.prototype.getNonDefaultSiblingsList_asB64 = function() {
  return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(
      this.getNonDefaultSiblingsList()));
};
 ...
 * @return {!Array<!Uint8Array>}
 */
proto.types.AccumulatorConsistencyProof.prototype.getNonDefaultSiblingsList_asU8 = function() {
  return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(
      this.getNonDefaultSiblingsList()));
};
...
/** @param {!(Array<!Uint8Array>|Array<string>)} value */
proto.types.AccumulatorConsistencyProof.prototype.setNonDefaultSiblingsList = function(value) {
  jspb.Message.setField(this, 3, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.types.AccumulatorConsistencyProof.prototype.addNonDefaultSiblings = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};


proto.types.AccumulatorConsistencyProof.prototype.clearNonDefaultSiblingsList = function() {
  this.setNonDefaultSiblingsList([]);
};
