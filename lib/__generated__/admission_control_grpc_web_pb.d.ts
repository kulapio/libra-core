...
import { SubmitTransactionRequest, SubmitTransactionResponse } from './admission_control_pb';
...
export class AdmissionControlClient {
  ...
  submitTransaction(
    ...
    callback: (err: grpcWeb.Error, response: SubmitTransactionResponse) => void,
  ...
  updateToLatestLedger(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: get_with_proof_pb.UpdateToLatestLedgerResponse) => void,
...
export class AdmissionControlPromiseClient {
  ...
  submitTransaction(request: SubmitTransactionRequest, metadata?: grpcWeb.Metadata): Promise<SubmitTransactionResponse>;
