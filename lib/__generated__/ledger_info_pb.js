...
proto.types.LedgerInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    timestampUsecs: jspb.Message.getFieldWithDefault(msg, 7, 0),
 ...
 * @return {number}
 */
proto.types.LedgerInfo.prototype.getRound = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/** @param {number} value */
proto.types.LedgerInfo.prototype.setRound = function(value) {
  jspb.Message.setProto3IntField(this, 6, value);
};


/**
 * optional uint64 timestamp_usecs = 7;
 * @return {number}
 */
...
proto.types.LedgerInfo.prototype.getNextValidatorSet = function() {
  return /** @type{?proto.types.ValidatorSet} */ (
    jspb.Message.getWrapperField(this, validator_set_pb.ValidatorSet, 8));
};
