...
export class MempoolClient {
  ...
  addTransactionWithValidation(
    ...
    callback: (err: grpcWeb.Error, response: AddTransactionWithValidationResponse) => void,
  ): grpcWeb.ClientReadableStream<AddTransactionWithValidationResponse>;

  getBlock(
    request: GetBlockRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: GetBlockResponse) => void,
  ): grpcWeb.ClientReadableStream<GetBlockResponse>;

  commitTransactions(
    request: CommitTransactionsRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: CommitTransactionsResponse) => void,
  ): grpcWeb.ClientReadableStream<CommitTransactionsResponse>;

  healthCheck(
    request: HealthCheckRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: HealthCheckResponse) => void,
...
export class MempoolPromiseClient {
  ...
  getBlock(request: GetBlockRequest, metadata?: grpcWeb.Metadata): Promise<GetBlockResponse>;
  ...
  healthCheck(request: HealthCheckRequest, metadata?: grpcWeb.Metadata): Promise<HealthCheckResponse>;
}
