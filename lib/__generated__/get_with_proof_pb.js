...
proto.types.UpdateToLatestLedgerResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proof_pb.AccumulatorConsistencyProof.serializeBinaryToWriter
    );
  }
};
...
proto.types.UpdateToLatestLedgerResponse.prototype.getValidatorChangeEvents = function() {
  return /** @type{?proto.types.ValidatorChangeEventWithProof} */ (
    jspb.Message.getWrapperField(this, validator_change_pb.ValidatorChangeEventWithProof, 3));
};
...
proto.types.UpdateToLatestLedgerResponse.prototype.getLedgerConsistencyProof = function() {
  return /** @type{?proto.types.AccumulatorConsistencyProof} */ (
    jspb.Message.getWrapperField(this, proof_pb.AccumulatorConsistencyProof, 4));
};
...
proto.types.GetAccountTransactionBySequenceNumberResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      transaction_pb.TransactionWithProof.serializeBinaryToWriter
    );
  }
...
proto.types.GetAccountTransactionBySequenceNumberResponse.prototype.getTransactionWithProof = function() {
  return /** @type{?proto.types.TransactionWithProof} */ (
    jspb.Message.getWrapperField(this, transaction_pb.TransactionWithProof, 2));
};
